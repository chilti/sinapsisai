...
def main():
    ...
    AS SELECT
        ...
        CAST([] AS Array(Float32)) AS embedding_nomic,
        CAST([] AS Array(Float32)) AS embedding_specter,
        CAST([] AS Array(Float32)) AS embedding_fastrp
    FROM rag.works
    """
    ch.command(create_mv_query)
    print("Created new MV with updated fields.")
