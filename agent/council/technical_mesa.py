...
async def _run_mesa_async(
    ...
    arquitecto = AssistantAgent(
        ...
        system_message=(
            ...
            f"9. DATOS DISPONIBLES EN EL SISTEMA:\n"
            f"   - Relaciones SDG/ODS: Existen nodos :SDG y relación :ADDRESSES (Paper->SDG).\n"
            f"   - Parquets pre-calculados: Disponibles en 'data/cache/<Entidad>/<Academico>/'.\n"
            f"   - Propiedades en Autores: gender o ethnicity NO están disponibles (no los pidas).\n"
            f"   - Impact Factor: No disponible directamente en el grafo.\n"
            f"10. Si un objetivo requiere datos externos (Scopus/OpenAlex), el script debe prever su descarga primero.\n"
