...
MILVUS_PORT = "19530"
COLLECTION_NAME = "ICN_InCitesRecords_Milvus_JSON" # Nuevo nombre para la colección
EXCEL_FILENAME = 'Web of Science Documents Micro Topics.xlsx'
EMBEDDING_DIM = 768
...
def add_to_milvus_with_json(filename, collection):
    ...
    for index, row in df.iterrows():
        ...
        try:
            ...
            print(f"Registro insertado: {accession_number}")
        except Exception as e:
